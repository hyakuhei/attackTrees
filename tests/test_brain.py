from attacktree.models import Action, Block, Detect, Discovery, Edge, Root, Goal, mitreAttack, rules
...
def basicTree():
    ...
    dnsEnumeration = root.add(Action(
    ...
    linkedInResearch = root.add(Action(
